...
Source of truth: `../standards/commit-standard.md`.

This file remains as a detailed workflow reference. New organization-wide commit rules
should update the canonical standard first.
