...
Source of truth: `../../standards/ai-usage-standard.md`.

This file remains as a detailed reference for AI-assisted development risks. New
organization-wide policy changes should update the canonical standard first.
