...
Source of truth: `../standards/testing-standard.md` for testing expectations and
`../checklists/pre-commit-checklist.md` for change verification gates.

This file remains as a detailed verification reference. New organization-wide testing
rules should update the canonical standard first.
