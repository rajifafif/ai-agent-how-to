...
| 10 | Implementasi AI-Agent Ready Repository | Repository AI-Agent Ready Bootstrap | Done | `scripts/bootstrap-agent-ready.sh`, `prompts/bootstrap-existing-project.md`, `templates/AGENTS.template.md`. Supersedes removed starter-pack README folders. |
| 10 | Implementasi AI-Agent Ready Repository | Template README & AI Agent Instructions | Done | `templates/AGENTS.template.md`, `templates/AGENTS.template.id.md`, `templates/PROJECT_CONTEXT.template.md`, `prompts/bootstrap-existing-project.md`. |
