...
|---|---|---|
| Authentication | A01, A04, A07 | Critical |
| API endpoints | A01, A05, A06, A10 | Critical |
| User input forms | A05, A08 | High |
| File upload/download | A01, A06, A08 | High |
| Admin panels | A01, A02, A07 | Critical |
| Third-party integrations | A03, A08, A10 | Medium |
...
```
Checklist:
[ ] Run dependency audit with project-appropriate tools when available
[ ] Check for known CVEs in direct and transitive dependencies
[ ] Verify dependency versions are maintained and lock files are committed
[ ] Review CI/CD workflows for secret exposure and untrusted execution
[ ] Confirm build artifacts are traceable to trusted source
...
[ ] Security-critical dependency failures fail closed
