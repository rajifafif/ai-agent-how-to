...
3. For non-trivial bugs, read `prompts/plan-feature.md` if it exists, then create or update a persistent investigation plan in `docs/plans/` using `templates/IMPLEMENTATION_PLAN.template.md` before editing.
