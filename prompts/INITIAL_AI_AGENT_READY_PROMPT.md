...
1. If `guide-templates/docs/ai-agent-guide.md` exists, read it completely and use `guide-templates/templates/AGENTS.template.md` as the source template if present. Also read `guide-templates/docs/planning-loop-guide.md` if present.
2. Otherwise, if `docs/ai-agent-guide.md` already exists, read it completely and follow it as the operating guide for this setup. Also read `docs/planning-loop-guide.md` if present.
...
- Create `docs/ai-agent-guide.md` in this repository as part of the setup when appropriate.
...
- Create or update `docs/planning-loop-guide.md` when the project will use phased plans for larger tasks.
...
6. Create or update `docs/planning-loop-guide.md` so larger tasks use a phased planning loop before implementation.
