...
1. If `guide-templates/docs/ai-agent-guide.md` exists, read it completely and use `guide-templates/templates/AGENTS.template.md` as the source template if present.
2. Otherwise, if `docs/ai-agent-guide.md` already exists, read it completely and follow it as the operating guide for this setup.
