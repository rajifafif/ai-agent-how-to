...
2. Read docs/security/ai-assisted-development-standard.md if it exists.
3. Read docs/security/security-review-guide.md if it exists.
4. Read docs/security/secure-coding-checklist.md if it exists.
